...
description: Next Briosa Python APIs for reviewed Robot Calibration Appliance Node MP commands.
...
These coroutines cover all twenty-five group commands and are not
