...
description: Next Briosa Python APIs for the reviewed Instrument Operations MP commands.
...
These coroutines define the next package surface and are not released support
