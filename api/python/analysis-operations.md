...
async def make_circle_fit_profile(
    ...
    *,
    fit_profile_name: str = '',
    measured_side_for_radial_offset: MeasuredSideForRadialOffset = MeasuredSideForRadialOffset.DEFAULT,
    override_radial_offset_1_0_use_current: float = -1.000000,
    measured_side_for_planar_offset: MeasuredSideForPlanarOffset = MeasuredSideForPlanarOffset.DEFAULT,
    override_planar_offset_1_0_use_current: float = -1.000000,
    planar_offset_direction: NormalDirection = NormalDirection.DEFAULT,
    lock_radius_1_0_do_not_lock: float = -1.000000,
    circle_computation_technique: CompTechnique = CompTechnique.DEFAULT,
...
async def make_cylinder_fit_profile(
    ...
    *,
    ...
    override_radial_offset_1_0_use_current: float = -1.000000,
    lock_radius_1_0_do_not_lock: float = -1.000000,
    locked_radius_fit_method: FitMethod = FitMethod.DEFAULT,
    ...
    cylinder_computation_technique: CompTechnique = CompTechnique.DEFAULT,
...
async def make_paraboloid_fit_profile(
    ...
    *,
    ...
    degree_of_freedom: DegreeOfFreedom = DegreeOfFreedom.DEFAULT,
    make_cardinal_points: bool = True,
    cardinal_pt_1_vertex: bool = True,
...
async def make_slot_fit_profile(
    ...
    *,
    ...
    override_planar_offset_1_0_use_current: float = -1.000000,
    planar_offset_direction: NormalDirection = NormalDirection.DEFAULT,
    slot_type: SlotType = SlotType.DEFAULT,
    slot_computation_technique: CompTechnique = CompTechnique.DEFAULT,
    reverse_normal_vector_after_fit: bool = False,
    make_cardinal_points: bool = True,
    cardinal_pt_1_center: bool = True,
    cardinal_pt_2_point_on_normal: bool = True,
...
async def make_sphere_fit_profile(
    ...
    *,
    ...
    make_cardinal_points: bool = True,
    cardinal_pt_1_center: bool = True,
    computation_method: SphereFitComputationMode = SphereFitComputationMode.DEFAULT,
) -> None: ...
```
