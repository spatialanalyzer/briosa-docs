...
description: Current and Next Briosa .NET APIs for selected collection-management MP commands.
...
signatures define its first-party wrapper and the four Next collection-mutation
