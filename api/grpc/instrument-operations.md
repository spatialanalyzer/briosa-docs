...
| Message | Field | Name | Type | MP Argument | Briosa Default |
| --- | ---: | --- | --- | --- | --- |
| Request | 1 | `instrument` | `optional CollectionInstrumentId` | Instrument to get | Required |
...
[MP Catalog](/mp-command-catalog/commands/instrument-operations#get-instrument-measurement-modeprofile)

`/briosa.InstrumentOperations/GetInstrumentMeasurementModeProfile` · Operation ID: `instrument_operations.get_instrument_measurement_mode_profile`

| Message | Field | Name | Type | MP Argument | Briosa Default |
| --- | ---: | --- | --- | --- | --- |
| Request | 1 | `instrument` | `optional CollectionInstrumentId` | Instrument to set | Required |
| Result | 1 | `mode_profile` | `string` | Mode/Profile | — |
| Result | 1000 | `execution` | `MpExecutionDetails` | Execution Details | — |
...
[MP Catalog](/mp-command-catalog/commands/instrument-operations#get-instrument-group-and-target)

`/briosa.InstrumentOperations/GetInstrumentGroupAndTarget` · Operation ID: `instrument_operations.get_instrument_group_and_target`

| Message | Field | Name | Type | MP Argument | Briosa Default |
| --- | ---: | --- | --- | --- | --- |
| Request | 1 | `instrument` | `optional CollectionInstrumentId` | Instrument ID | Required |
| Result | 1 | `point` | `optional PointName` | Point Name | — |
| Result | 1000 | `execution` | `MpExecutionDetails` | Execution Details | — |
...
[MP Catalog](/mp-command-catalog/commands/instrument-operations#get-instrument-targeting)

`/briosa.InstrumentOperations/GetInstrumentTargeting` · Operation ID: `instrument_operations.get_instrument_targeting`

| Message | Field | Name | Type | MP Argument | Briosa Default |
| --- | ---: | --- | --- | --- | --- |
| Request | 1 | `instrument` | `optional CollectionInstrumentId` | Instrument ID | Required |
| Result | 1 | `targeting_name` | `string` | Targeting Name | — |
| Result | 1000 | `execution` | `MpExecutionDetails` | Execution Details | — |
...
[MP Catalog](/mp-command-catalog/commands/instrument-operations#scan-within-perimeter)

`/briosa.InstrumentOperations/ScanWithinPerimeter` · Operation ID: `instrument_operations.scan_within_perimeter`

| Message | Field | Name | Type | MP Argument | Briosa Default |
| --- | ---: | --- | --- | --- | --- |
| Request | 1 | `instrument` | `optional CollectionInstrumentId` | Instrument to scan | Required |
| Request | 2 | `scan_perimeters` | `repeated CollectionObjectName` | Scan perimeter list | Required |
| Request | 3 | `exclusion_perimeters` | `repeated CollectionObjectName` | Exclusion perimeter list | Required |
...
message ScanWithinPerimeterResult {
  MpExecutionDetails execution = 1000;
}
```
...
[MP Catalog](/mp-command-catalog/commands/instrument-operations#edit-scan-perimeter-profile)

`/briosa.InstrumentOperations/EditScanPerimeterProfile` · Operation ID: `instrument_operations.edit_scan_perimeter_profile`
...
| Request | 3 | `exclusion_perimeters` | `repeated CollectionObjectName` | Exclusion perimeter list | Required |
| Request | 4 | `parameter_set_name` | `optional string` | Parameter set name | Empty |
| Request | 5 | `profile_name` | `optional string` | Profile name | Empty |
| Request | 6 | `clear_profile` | `optional bool` | Clear Profile? | true |
| Request | 7 | `create_new_profile` | `optional bool` | Create New Profile? | false |
| Result | 1000 | `execution` | `MpExecutionDetails` | Execution Details | — |
...
message EditScanPerimeterProfileResult {
  MpExecutionDetails execution = 1000;
}
```
...
[MP Catalog](/mp-command-catalog/commands/instrument-operations#scan-cad-faces)

`/briosa.InstrumentOperations/ScanCadFaces` · Operation ID: `instrument_operations.scan_cad_faces`

| Message | Field | Name | Type | MP Argument | Briosa Default |
| --- | ---: | --- | --- | --- | --- |
| Request | 1 | `instrument` | `optional CollectionInstrumentId` | Instrument to scan | Required |
| Request | 2 | `surface_faces` | `optional SurfaceFaceList` | Surface Faces | Empty |
| Request | 3 | `parameter_set_name` | `optional string` | Parameter set name | Empty |
| Request | 4 | `enable_exclusions` | `optional bool` | Enable exclusions? | true |
| Request | 5 | `wait_for_completion` | `optional bool` | Wait for Completion | true |
| Result | 1000 | `execution` | `MpExecutionDetails` | Execution Details | — |
...
[MP Catalog](/mp-command-catalog/commands/instrument-operations#get-inspection-verification-mode)

`/briosa.InstrumentOperations/GetInspectionVerificationMode` · Operation ID: `instrument_operations.get_inspection_verification_mode`

| Message | Field | Name | Type | MP Argument | Briosa Default |
| --- | ---: | --- | --- | --- | --- |
| Result | 1 | `verification_enabled` | `bool` | Verification Enabled? | — |
| Result | 1000 | `execution` | `MpExecutionDetails` | Execution Details | — |
...
[MP Catalog](/mp-command-catalog/commands/instrument-operations#set-inspection-verification-mode)

`/briosa.InstrumentOperations/SetInspectionVerificationMode` · Operation ID: `instrument_operations.set_inspection_verification_mode`

| Message | Field | Name | Type | MP Argument | Briosa Default |
| --- | ---: | --- | --- | --- | --- |
| Request | 1 | `verification_enabled` | `optional bool` | Enable Verification? | false |
| Result | 1000 | `execution` | `MpExecutionDetails` | Execution Details | — |
...
message SetInspectionVerificationModeResult {
  MpExecutionDetails execution = 1000;
}
```
