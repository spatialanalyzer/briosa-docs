...
| Request | 27 | `surface_compatibility_mode` | `optional bool` | Surface Compatibility Mode | true |
...
| Request | 6 | `include_cloud_point_labeling` | `optional bool` | Include Cloud Point Labeling? | false |
| Request | 7 | `include_scan_direction_vector` | `optional bool` | Include Scan Direction Vector? | false |
| Result | 1000 | `execution` | `MpExecutionDetails` | Execution Details | — |
...
| Request | 12 | `k0004_date_time_stamp` | `optional string` | K0004: Date Time Stamp | 2026-07-20/16:32:22 |
...
| Request | 11 | `k0004_date_time_stamp` | `optional string` | K0004: Date Time Stamp | 2026-07-20/16:32:22 |
...
[MP Catalog](/mp-command-catalog/commands/file-operations#use-nrkxml-library)

`/briosa.FileOperations/UseNrkxmlLibrary` · Operation ID: `file_operations.use_nrkxml_library`

| Message | Field | Name | Type | MP Argument | Briosa Default |
| --- | ---: | --- | --- | --- | --- |
| Request | 1 | `use_library` | `optional bool` | Use library? | true |
| Result | 1000 | `execution` | `MpExecutionDetails` | Execution Details | — |
