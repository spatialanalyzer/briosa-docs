...
The [released protobuf source](https://github.com/spatialanalyzer/briosa/tree/v0.7.0/targets/2024.1.0508.5/proto/briosa)
...
This section covers **SA 2024.1.0508.5**. Return to [SA 2026.1.0529.7](/api/grpc). Both references belong to product release 0.7.0.
