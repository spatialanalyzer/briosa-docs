...
description: Server 0.7.0 exact-target protobuf values for SA 2024.1.0508.5.
---
...
These are the released Server **0.7.0** protobuf values for **SA 2024.1.0508.5**. Preserve reserved numbers and exact-target domains. Client libraries expose their own handwritten representations.
