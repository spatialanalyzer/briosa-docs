...
description: Next gRPC contracts for reviewed Nikon Metrology Laser Radars LR MP commands.
...
These contracts cover all twelve subgroup commands and are not
