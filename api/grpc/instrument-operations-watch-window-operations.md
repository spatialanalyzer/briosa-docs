...
description: Next gRPC contract for reviewed Watch Window Operations.
...
Six of the seven reviewed subgroup commands have approved RPC contracts. They
are not callable until released. `Watch Window Template 3D` remains
Uncommitted pending exact-target signature clarification.
