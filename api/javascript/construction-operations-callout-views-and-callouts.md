...
description: Next Briosa JavaScript and TypeScript APIs for selected callout-view MP commands.
...
These functions are not released support until implemented and versioned.
:::
