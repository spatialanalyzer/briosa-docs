...
description: Next Briosa JavaScript and TypeScript APIs for the reviewed Instrument Operations MP commands.
...
These functions define the next package surface and are not released support
