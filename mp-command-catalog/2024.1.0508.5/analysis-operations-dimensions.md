...
| --- | --- | --- |
| [Add a Dimension to Dimension Ref List](/mp-command-catalog/commands/dimension-operations#add-a-dimension-to-dimension-ref-list) | **SDK Unavailable** | Evidence review |
| [Create Diameter Dimension](/mp-command-catalog/commands/dimension-operations#create-diameter-dimension) | **SDK Unavailable** | Evidence review |
| [Create Object to Object Dimension](/mp-command-catalog/commands/dimension-operations#create-object-to-object-dimension) | **SDK Unavailable** | Evidence review |
...
| [Make a Dimension Ref List from a Collection](/mp-command-catalog/commands/dimension-operations#make-a-dimension-ref-list-from-a-collection) | **SDK Unavailable** | Evidence review |
...
| [Set Radius Dimension Properties](/mp-command-catalog/commands/dimension-operations#set-radius-dimension-properties) | **SDK Unavailable** | Evidence review |
