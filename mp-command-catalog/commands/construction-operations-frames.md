---
title: Construction Operations / Frames Commands
description: Canonical MP command dispositions for the Construction Operations / Frames subgroup.
...
<CatalogFilter showTargetFilter scopedGroup="Construction Operations / Frames" />
...
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Frames" data-validation="at-risk-interactive-fixture-validation-required">
...
| --- | --- | --- | --- | --- |
| Input | `New Frame Name` | Collection Object Name | Empty frame identity | Required |
| Input | `Wait for Completion` | Boolean | true | true |

Opens SpatialAnalyzer's frame-construction wizard. The call may remain active
while an operator completes the wizard. Cancellation does not prove that the
wizard closed, and Briosa never automatically replays the operation.

## Construct Frame

<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Frames" data-validation="at-risk-fixture-validation-required">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Frames</span>
...
Constructs a frame from a transform expressed in the current working
coordinates.
...
| --- | --- | --- | --- | --- |
| Input | `New Frame Name` | Collection Object Name | Empty frame identity | Required |
| Input | `Transform in World Coordinates` | Transform | Identity | Identity |

Constructs a frame from a transform expressed in world coordinates.

## Construct Frame on Instrument Base

<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Frames" data-validation="at-risk-instrument-fixture-validation-required">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Frames</span>
...
| Direction | Exact MP Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `Instrument ID` | Collection Instrument ID | Empty | Required |
| Input | `Frame Name (Optional)` | Frame Name | Empty | Omitted |

Constructs a frame at the base of an existing instrument. Its validation needs
an instrument fixture but the fixture dependency does not reduce the API
commitment.
...
| Direction | Exact MP Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `Reference Object` | Collection Object Name | Empty, Any object type | Required |
| Input | `Frame Name (Optional)` | Collection Object Name | Empty frame identity | Omitted |

Constructs a frame from an object's position and orientation.
...
| Direction | Exact MP Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `Construction Method` | 3Pt Frame Construction Method | Empty | Required typed choice |
| Input | `Origin Point` | Point Name | Empty | Required |
| Input | `Primary Axis Point` | Point Name | Empty | Required |
| Input | `Secondary Axis Point` | Point Name | Empty | Required |
| Input | `Frame Name (Optional)` | Frame Name | Empty | Omitted |

The construction-method type exposes the six exact SA choices documented by
the MP type rather than accepting an arbitrary string.
...
| --- | --- | --- | --- | --- |
| Input | `Origin Point` | Point Name | Empty | Required |
| Input | `Clocked axis` | Axis Identifier | Empty | Required typed choice |
| Input | `Clocking Point` | Point Name | Empty | Required |
| Input | `Frame Name (Optional)` | Frame Name | Empty | Omitted |

The clocked-axis choice includes positive and negative X, Y, and Z axes.
...
| --- | --- | --- | --- | --- |
| Input | `Origin Point` | Point Name | Empty | Required |
| Input | `Point on X-Axis` | Point Name | Empty | Required |
| Input | `Frame Name (Optional)` | Frame Name | Empty | Omitted |

Constructs a frame using two points while clocking its Z axis along the working
Z direction.
...
| Direction | Exact MP Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `Known Point` | Point Name | Empty | Required |
| Input | `Known Point Value in New Frame` | Vector | zero vector | Required |
| Input | `Primary Axis Object` | Collection Object Name | Empty | Required |
| Input | `Primary Axis Defines Which Axis` | Axis Identifier | Empty | Required typed choice |
| Input | `Secondary Axis Object` | Collection Object Name | Empty | Required |
| Input | `Secondary Axis Defines Which Axis` | Axis Identifier | Empty | Required typed choice |
| Input | `Frame Name (Optional)` | Collection Object Name | Empty frame identity | Omitted |

Briosa preserves both object directions and their independent signed-axis
choices. Values are passed through for SpatialAnalyzer to evaluate.
...
| Direction | Exact MP Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `X Plane` | Collection Object Name | Empty plane identity | Required |
| Input | `X Value on PLane` | Double | 0 | Required |
| Input | `Y Plane` | Collection Object Name | Empty plane identity | Required |
| Input | `Y Value on PLane` | Double | 0 | Required |
| Input | `Z Plane` | Collection Object Name | Empty plane identity | Required |
| Input | `Z Value on Plane` | Double | 0 | Required |
| Input | `Frame Name (Optional)` | Collection Object Name | Empty frame identity | Omitted |

The unusual capitalization in `X Value on PLane` and `Y Value on PLane` is
part of the exact MP binding and is preserved by the server mapping.
...
| Direction | Exact MP Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `Reference Frame` | Collection Object Name | Empty frame identity | Required |
| Input | `Frame Name (Optional)` | Collection Object Name | Empty | Omitted |
| Input | `Axis to reverse` | Axis Identifier | Empty | Required X, Y, or Z choice |

Copies a frame and reverses one unsigned axis to make the result left handed.
...
| Direction | Exact MP Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `Objects` | Collection Object Name Ref List | Empty | Required |
| Input | `Frame Name (Optional)` | Collection Object Name | Empty frame identity | Omitted |

Constructs a frame representing the average position and orientation of the
supplied objects. Briosa does not add a minimum-list-size rule.

## Construct Frame at Robot Link

<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Frames" data-validation="at-risk-robot-fixture-validation-required">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Frames</span>
...
| Direction | Exact MP Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `Machine ID` | Collection Machine ID | Empty | Required |
| Input | `Link Name` | String | Empty | Required |
| Input | `Resulting Frame` | Collection Object Name | Empty frame identity | Required |

Constructs a frame at an existing robot link. Validation needs a configured
robot or machine fixture.

## Construct Frame From Point Measurement Probing Frames

<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Frames" data-validation="at-risk-probing-data-fixture-validation-required">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Frames</span>
...
| Direction | Exact MP Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `Point List` | Point Name Ref List | Empty | Required |
| Input | `Show Frame? (Hide = FALSE)` | Boolean | false | false |

Constructs probing frames for points whose measurements carry probing-frame
metadata.

## Construct Mirror Cube Frame

<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Frames" data-validation="at-risk-mirror-measurement-fixture-validation-required">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Frames</span>
...
| Direction | Exact MP Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `Mirror Cube Frame Name` | Collection Object Name | Empty frame identity | Required |
| Input | `Point Name` | Point Name | Empty | Required |
| Input | `Use Current Measurements Marked as Mirror Shots` | Boolean | true | true |
| Input | `Nominal Cube Face Angle` | Double | 90 | 90 |
| Output | `Total Angular Error` | Double | - | Returned |

Returns the exact angular-error result and requires a mirror-measurement
fixture for licensed validation.

## Construct Frames By Projecting Frames On Mesh Along Frame Direction

<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Frames" data-validation="at-risk-mesh-fixture-validation-required">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Frames</span>
...
| Direction | Exact MP Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `Reference Frame Names` | Collection Object Name Ref List | Empty | Required |
| Input | `Base Name For Projected Frames` | Collection Object Name | Empty frame identity | Required |
| Input | `Bi-directional projection?` | Boolean | true | true |
| Input | `Mesh Serving As Projection Target` | Collection Object Name | Empty scan-stripe mesh identity | Required |
| Output | `Resultant Frame Name List` | Collection Object Name Ref List | - | Returned |

Returns every frame constructed by projecting the source frames along their
own directions.
...
| Input | `Reference Frame Names` | Collection Object Name Ref List | Empty | Required |
| Input | `Base Name For Projected Frames` | Collection Object Name | Empty frame identity | Required |
| Input | `Object Providing Direction Reference` | Collection Object Name | Empty, Any object type | Required |
| Input | `Bi-directional projection?` | Boolean | true | true |
| Input | `Mesh Serving As Projection Target` | Collection Object Name | Empty scan-stripe mesh identity | Required |
| Output | `Resultant Frame Name List` | Collection Object Name Ref List | - | Returned |

Uses one supplied object's direction as the projection reference and returns
the complete resultant-frame list.

## Add Surface To Mesh Offset Along Reference Direction

<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Frames" data-validation="at-risk-mesh-and-surface-fixture-validation-required">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Frames</span>
...
| --- | --- | --- | --- | --- |
| Input | `Reference Frame Names` | Collection Object Name Ref List | Empty | Required |
| Input | `Surface for Offset Distance Computation` | Collection Object Name | Empty surface identity | Required |
| Input | `Surface Offset Range` | Double | 10 | 10 |
| Input | `Collection for Result Frames` | String | Empty | Required |
| Input | `Object Providing Direction Reference` | Collection Object Name | Empty, Any object type | Required |
| Input | `Bi-directional projection?` | Boolean | true | true |
| Input | `Mesh Serving As Projection Target` | Collection Object Name | Empty scan-stripe mesh identity | Required |

Combines frame, surface, direction-reference, and mesh inputs to construct
offset result frames. The group placement and exact command label are
preserved even though the label does not begin with `Construct Frame`.
