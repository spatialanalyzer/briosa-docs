---
title: Excel Direct Connect Commands
description: Canonical SpatialAnalyzer MP command dispositions for Excel Direct Connect.
toc_max_heading_level: 2
---

import CatalogFilter from '@site/src/components/CatalogFilter';

# Excel Direct Connect Commands
...
<div className="catalog-command-meta">
  ...
  <div><span>MP Group Path</span><strong>Excel Direct Connect</strong></div>
...
| --- | --- | --- | --- | --- |
| Input | `Workbook Handle` | Integer | 0 | Not applicable |
...
**Recommended Alternative:** Use a .NET, Python, or JavaScript Excel library.
...
| Direction | Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `Workbook File Path` | File Path or Embedded File | Empty | Not applicable |
| Input | `Verify File Exists?` | Boolean | false | Not applicable |
...
<div className="catalog-command-meta">
  <div><span>Reviewed SA Target</span><strong>2026.1.0529.7</strong></div>
  <div><span>MP Group Path</span><strong>Excel Direct Connect / Read</strong></div>
  <div><span>Validation</span><strong>Not applicable</strong></div>
  <div><span>SDK Observation</span><strong>Present</strong></div>
</div>
...
| --- | --- | --- | --- | --- |
| Input | `Workbook Handle` | Integer | 0 | Not applicable |
| Input | `Macro Name` | String | Empty | Not applicable |
...
| --- | --- | --- | --- | --- |
| Input | `Workbook Handle` | Integer | 0 | Not applicable |
| Input | `Clear Comments` | Boolean | false | Not applicable |
| Input | `Clear Formulas` | Boolean | false | Not applicable |
| Input | `Clear Formats` | Boolean | false | Not applicable |
| Input | `Clear Notes` | Boolean | false | Not applicable |
| Input | `Clear Outline` | Boolean | false | Not applicable |
...
| --- | --- | --- | --- | --- |
| Input | `Workbook Handle` | Integer | 0 | Not applicable |
| Input | `Addressing Mode` | WorkbookAddressModeType | Empty | Not applicable |
| Input | `Absolute Position Worksheet Name` | String | Empty | Not applicable |
| Input | `Absolute Position Column (A, B, C, ...)` | String | Empty | Not applicable |
| Input | `Absolute Position Row (1, 2, 3, ...)` | Integer | 0 | Not applicable |
| Input | `Relative Move Direction` | MoveDirectionType | Empty | Not applicable |
| Input | `Relative Move # Cells` | Integer | 0 | Not applicable |
| Input | `Named Cell/Range in Workbook` | String | Empty | Not applicable |
| Input | `Write Mode` | WriteModeType | Empty | Not applicable |
| Input | `Auto Move Direction` | MoveDirectionType | Empty | Not applicable |
...
<div className="catalog-command-meta">
  <div><span>Reviewed SA Target</span><strong>2026.1.0529.7</strong></div>
  <div><span>MP Group Path</span><strong>Excel Direct Connect / Write</strong></div>
  <div><span>Validation</span><strong>Not applicable</strong></div>
  <div><span>SDK Observation</span><strong>Present</strong></div>
</div>
...
| --- | --- | --- | --- | --- |
| Input | `Workbook Handle` | Integer | 0 | Not applicable |
| Input | `Data to Write` | Double | 0.000000 | Not applicable |
...
| --- | --- | --- | --- | --- |
| Input | `Workbook Handle` | Integer | 0 | Not applicable |
| Input | `Data to Write` | Integer | 0 | Not applicable |
...
| --- | --- | --- | --- | --- |
| Input | `Workbook Handle` | Integer | 0 | Not applicable |
| Input | `Data to Write` | String | Empty | Not applicable |
