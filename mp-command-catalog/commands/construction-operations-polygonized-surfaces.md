...
<tbody>
<tr data-command="Construct Polygonized Surface from Point Clouds" data-group="Construction Operations / Polygonized Surfaces" data-status="current" data-validation="at-risk-dense-point-cloud-fixture"><td><a href="#construct-polygonized-surface-from-point-clouds">Construct Polygonized Surface from Point Clouds</a></td><td><span className="catalog-status catalog-status--current">Current</span></td><td>At Risk - dense point-cloud fixture</td></tr>
</tbody>
</table>
