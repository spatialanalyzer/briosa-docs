---
title: Scalar Math Operations Commands
description: Canonical SpatialAnalyzer MP command dispositions for Scalar Math Operations.
toc_max_heading_level: 2
---

import CatalogFilter from '@site/src/components/CatalogFilter';

# Scalar Math Operations Commands
...
<div className="catalog-command-meta">
  ...
  <div><span>MP Group Path</span><strong>Scalar Math Operations</strong></div>
...
| --- | --- | --- | --- | --- |
| Input | `Boolean A` | Boolean | false | Not applicable |
| Input | `Boolean B` | Boolean | false | Not applicable |
| Input | `Step if Same` | SDK-unavailable MP argument | Unavailable | Not applicable |
| Input | `Step if Different` | SDK-unavailable MP argument | Unavailable | Not applicable |

### Briosa Disposition

The exact SDK cannot supply `Step if Same`, `Step if Different`, so Briosa cannot expose the complete useful operation.
...
| Direction | Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `String` | String | Empty | Not applicable |
| Input | `Upper Case?` | Boolean | false | Not applicable |
...
| Direction | Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `Color A` | Color | RGB 255, 0, 0 | Not applicable |
| Input | `Color B` | Color | RGB 255, 0, 0 | Not applicable |
| Input | `Allowable Deviation (Red)` | Integer | 0 | Not applicable |
| Input | `Allowable Deviation (Green)` | Integer | 0 | Not applicable |
| Input | `Allowable Deviation (Blue)` | Integer | 0 | Not applicable |
| Input | `Step if Same` | SDK-unavailable MP argument | Unavailable | Not applicable |
| Input | `Step if Different` | SDK-unavailable MP argument | Unavailable | Not applicable |
...
| Direction | Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `String to Check` | String | Empty | Not applicable |
| Input | `Sub-String` | String | Empty | Not applicable |
| Input | `Case sensitive?` | Boolean | true | Not applicable |
| Input | `Step if TRUE` | SDK-unavailable MP argument | Unavailable | Not applicable |
| Input | `Step if FALSE` | SDK-unavailable MP argument | Unavailable | Not applicable |
...
| Direction | Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `Double In` | Double | 0.000000 | Not applicable |
...
| Direction | Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `Input Ang Units` | Angular Units | Degrees | Not applicable |
| Input | `Input Angle Double` | Double | 0.000000 | Not applicable |
| Input | `Output Ang Units` | Angular Units | Degrees | Not applicable |
...
| Direction | Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `Double A` | Double | 0.000000 | Not applicable |
| Input | `Comparison Type` | NumComparisonType | Empty | Not applicable |
| Input | `Double B` | Double | 0.000000 | Not applicable |
| Input | `Step if TRUE` | SDK-unavailable MP argument | Unavailable | Not applicable |
| Input | `Step if FALSE` | SDK-unavailable MP argument | Unavailable | Not applicable |

### Briosa Disposition

The exact SDK cannot supply `Step if TRUE`, `Step if FALSE`, so Briosa cannot expose the complete useful operation.
...
| Direction | Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `First Value` | Double | 0.000000 | Not applicable |
| Input | `Operation` | MathOperation | Empty | Not applicable |
| Input | `Second Value` | Double | 0.000000 | Not applicable |
...
| Direction | Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `Integer In` | Integer | 0 | Not applicable |
...
| Direction | Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `Integer A` | Integer | 0 | Not applicable |
| Input | `Comparison Type` | NumComparisonType | Empty | Not applicable |
| Input | `Integer B` | Integer | 0 | Not applicable |
| Input | `Step if TRUE` | SDK-unavailable MP argument | Unavailable | Not applicable |
| Input | `Step if FALSE` | SDK-unavailable MP argument | Unavailable | Not applicable |
| Input | `Use for % complete` | Boolean | false | Not applicable |
...
| Direction | Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `First Value` | Integer | 0 | Not applicable |
| Input | `Operation` | MathOperation | Empty | Not applicable |
| Input | `Second Value` | Integer | 0 | Not applicable |
...
| Direction | Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `Function` | LogarithmicFunction | Empty | Not applicable |
| Input | `X Double In` | Double | 0.000000 | Not applicable |
| Output | `Double Result` | Double | — | — |
...
| --- | --- | --- | --- | --- |
| Input | `Double In` | Double | 0.000000 | Not applicable |
| Input | `Decimal Precision` | Integer | 0 | Not applicable |
| Output | `Double Result` | Double | — | — |
...
| Direction | Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `String A` | String | Empty | Not applicable |
| Input | `Comparison Type` | NumComparisonType | Empty | Not applicable |
| Input | `String B` | String | Empty | Not applicable |
| Input | `Case sensitive?` | Boolean | true | Not applicable |
| Input | `Step if TRUE` | SDK-unavailable MP argument | Unavailable | Not applicable |
| Input | `Step if FALSE` | SDK-unavailable MP argument | Unavailable | Not applicable |
...
| Direction | Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `Function` | TrigFunction | Empty | Not applicable |
| Input | `Angular Units` | Angular Units | Degrees | Not applicable |
| Input | `X Double In` | Double | 0.000000 | Not applicable |
| Input | `Y Double In` | Double | 0.000000 | Not applicable |
| Output | `Double Result` | Double | — | — |
