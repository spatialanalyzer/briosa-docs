...
These 58 reviewed relationship-scoped records were retained with the Wave A
Analysis source set. Fifty-five have exact Relationship Operations paths in the
SA 2026.1.0529.7 MP Editor; three documentation-only identities have no complete
exact-target SDK observation and are marked **SDK Unavailable**. The other 59
observed commands in this SA group remain future catalog work and have no
disposition yet. A **Next** entry is a documentation-first contract, not a claim
that the operation is callable in the current release.

<div className="catalog-context-grid">
  <div><span>Reviewed Commands</span><strong>58</strong></div>
  <div><span>Current or Next</span><strong>55</strong></div>
...
<tr data-command="Get Relationship Sigmoid Gap Fit Constraints" data-group="Relationship Operations / Relationship Attributes Scalar Types" data-status="sdk-unavailable" data-validation="not-applicable">
  <td><a href="#get-relationship-sigmoid-gap-fit-constraints">Get Relationship Sigmoid Gap Fit Constraints</a></td>
  <td>Relationship Operations / Relationship Attributes Scalar Types</td>
...
<tr data-command="Set Object to Object Direction Relationship Tolerance" data-group="Relationship Operations / Relationship Attributes Scalar Types" data-status="sdk-unavailable" data-validation="not-applicable">
  <td><a href="#set-object-to-object-direction-relationship-tolerance">Set Object to Object Direction Relationship Tolerance</a></td>
  <td>Relationship Operations / Relationship Attributes Scalar Types</td>
  <td><span className="catalog-status catalog-status--sdk-unavailable">SDK Unavailable</span></td>
  <td>Not applicable</td>
</tr>
...
## Get Relationship Sigmoid Gap Fit Constraints
...
| Output | `Gradient Steepness Factor` | Sigmoidal Gap Constraint Options | — | — |
...
| --- | --- | --- | --- | --- |
| Input | `Relationship Name` | Collection Object Name | Not established | Not applicable |
| Input | `Angle Between Vectors Tolerances` | Tolerance Options (Scalar Type) | Not established | Not applicable |
| Input | `Mutual Perpendicular Length Tolerances` | Tolerance Options (Scalar Type) | Not established | Not applicable |
