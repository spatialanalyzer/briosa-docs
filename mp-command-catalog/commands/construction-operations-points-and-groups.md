...
<div className="catalog-context-grid">
  ...
  <div><span>Current Server Operations</span><strong>53</strong></div>
  <div><span>Excluded or Unavailable</span><strong>4</strong></div>
</div>

<CatalogFilter showTargetFilter scopedGroup="Construction Operations / Points and Groups" />
...
<tr data-command="Make a Point Name from Strings" data-group="Construction Operations / Points and Groups" data-status="excluded" data-validation="evidence-review" data-target="2024.1.0508.5" hidden>
  <td><a href="#make-a-point-name-from-strings">Make a Point Name from Strings</a></td>
...
<tr data-command="Make a Point Name Ref List" data-group="Construction Operations / Points and Groups" data-status="excluded" data-validation="evidence-review" data-target="2024.1.0508.5" hidden>
  <td><a href="#make-a-point-name-ref-list">Make a Point Name Ref List</a></td>
  <td><span className="catalog-status catalog-status--excluded">Excluded</span></td>
  <td>Evidence review</td>
</tr>
...
<tr data-command="Append two Point Name Ref Lists" data-group="Construction Operations / Points and Groups" data-status="excluded" data-validation="evidence-review" data-target="2024.1.0508.5" hidden>
  <td><a href="#append-two-point-name-ref-lists">Append two Point Name Ref Lists</a></td>
  <td><span className="catalog-status catalog-status--excluded">Excluded</span></td>
  <td>Evidence review</td>
</tr>
<tr data-target="2026.1.0529.7" data-command="Subtract two Point Name Ref Lists" data-group="Construction Operations / Points and Groups" data-status="excluded" data-validation="portable-list-operation"><td><a href="#subtract-two-point-name-ref-lists">Subtract two Point Name Ref Lists</a></td><td><span className="catalog-status catalog-status--excluded">Excluded</span></td><td>Portable list operation</td></tr>
<tr data-command="Subtract two Point Name Ref Lists" data-group="Construction Operations / Points and Groups" data-status="excluded" data-validation="evidence-review" data-target="2024.1.0508.5" hidden>
  <td><a href="#subtract-two-point-name-ref-lists">Subtract two Point Name Ref Lists</a></td>
  <td><span className="catalog-status catalog-status--excluded">Excluded</span></td>
  <td>Evidence review</td>
</tr>
...
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Points and Groups" data-validation="at-risk-point-fixture">
...
| Input | `Working Coordinates` | Vector |
...
<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Points and Groups" data-validation="at-risk-survey-target-cloud-fixture">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
...
| Direction | Exact MP Argument | Argument Kind |
| --- | --- | --- |
| Input | `Cloud Containing Target` | Collection Object Name |
| Input | `Reference Seed Point` | Point Name |
| Input | `Survey Target Type` | String |
| Input | `Search Diameter` | Double |
| Input | `Result Center Point Name` | Point Name |
...
| --- | --- | --- |
| Input | `Point Name` | Point Name |
| Input | `Position In Working Coordinates` | Vector |
...
| Input | `Delta In Working Coordinates` | Vector |
...
<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Points and Groups" data-validation="at-risk-line-fixture">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
...
<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Points and Groups" data-validation="at-risk-vector-group-fixture">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
...
| Direction | Exact MP Argument | Argument Kind |
| --- | --- | --- |
| Input | `Vector Groups` | Collection Object Name Ref List |
| Input | `Optional Group Name Suffix` | String |
| Input | `Make Vector Begin Points` | Boolean |
| Input | `Make Vector End Points` | Boolean |
...
<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Points and Groups" data-validation="at-risk-point-cloud-fixture">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
...
| Input | `Point Prefix` | String |
| Input | `Starting Point Number` | Integer |
| Input | `Point Offset` | Double |
| Input | `Sub-Sampling?` | Boolean |
| Input | `Sub-Sampling Distance` | Double |
...
<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Points and Groups" data-validation="at-risk-interactive-cloud-fixture">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
...
| Direction | Exact MP Argument | Argument Kind |
| --- | --- | --- |
| Input | `Selection Prompt` | String |
| Input | `Construct Point?` | Boolean |
| Input | `Constructed Point Name` | Point Name |
| Output | `Selection Cloud Point Coordinates` | Vector |
...
<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Points and Groups" data-validation="at-risk-circle-fixture">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
...
<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Points and Groups" data-validation="at-risk-plane-fixture">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
...
| Direction | Exact MP Argument | Argument Kind |
| --- | --- | --- |
| Input | `Plane 1 Name` | Collection Object Name |
| Input | `Plane 2 Name` | Collection Object Name |
| Input | `Plane 3 Name` | Collection Object Name |
| Input | `Point Name` | Point Name |
...
| Direction | Exact MP Argument | Argument Kind |
| --- | --- | --- |
| Input | `First Line Name` | Collection Object Name |
| Input | `Second Line Name` | Collection Object Name |
| Input | `Resulting Point Name` | Point Name |
...
<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Points and Groups" data-validation="at-risk-plane-line-fixture">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
...
<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Points and Groups" data-validation="at-risk-b-spline-fixture">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
...
| Direction | Exact MP Argument | Argument Kind |
| --- | --- | --- |
| Input | `First B-Spline Name` | Collection Object Name |
| Input | `Second B-Spline Name` | Collection Object Name |
| Input | `Point Name` | Point Name |
...
<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Points and Groups" data-validation="at-risk-b-spline-and-surface-fixture">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
...
<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Points and Groups" data-validation="at-risk-circle-line-fixture">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
...
| Input | `Circle Name` | Collection Object Name |
| Input | `Line Name` | Collection Object Name |
| Input | `Base Point Name for results` | Point Name |
...
<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Points and Groups" data-validation="at-risk-axes-and-surface-fixture">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
...
| Direction | Exact MP Argument | Argument Kind |
| --- | --- | --- |
| Input | `Axis Object List` | Collection Object Name Ref List |
| Input | `Surface List` | Collection Object Name Ref List |
| Input | `Point Suffix (optional)` | String |
...
<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Points and Groups" data-validation="at-risk-cylinder-fixture">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
...
<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Points and Groups" data-validation="at-risk-projection-fixture">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
...
| Direction | Exact MP Argument | Argument Kind |
| --- | --- | --- |
| Input | `Point to Project` | Point Name |
...
| Input | `Surface List` | Collection Object Name Ref List |
| Input | `Point Names` | Point Name Ref List |
| Input | `Group Name to Contain New Points` | String |
| Input | `Point Name Prefix` | String |
| Input | `Point Name Suffix` | String |
...
<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Points and Groups" data-validation="at-risk-surface-fixture">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
...
| Input | `Generate output vector lines?` | Boolean |
| Output | `Projected Point` | Vector |
| Output | `Normal Vector` | Vector |
| Output | `U Direction` | Vector |
| Output | `V Direction` | Vector |
...
<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Points and Groups" data-validation="at-risk-surface-edge-fixture">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
...
| --- | --- | --- |
| Input | `Point to Project` | Point Name |
| Input | `Surface Edge (B-Spline)` | Collection Object Name |
| Input | `Surface Name` | Collection Object Name |
| Input | `Edge Offset Direction` | Vector |
| Input | `Edge Offset Distance` | Double |
| Input | `Generate output vector lines?` | Boolean |
| Output | `Projected Point` | Vector |
| Output | `Normal Vector` | Vector |
| Output | `U Direction` | Vector |
...
<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Points and Groups" data-validation="at-risk-mesh-fixture">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
...
| Direction | Exact MP Argument | Argument Kind |
| --- | --- | --- |
| Input | `Reference Point Names` | Point Name Ref List |
| Input | `Group Name For Projected Points` | Collection Object Name |
...
| Output | `Resultant Point Name List` | Point Name Ref List |
...
<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Points and Groups" data-validation="at-risk-curve-fixture">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
...
| Input | `Distance Between Points` | Double |
| Input | `Resultant Group Name` | Collection Object Name |
| Input | `Resultant Point Name Prefix` | String |
...
| --- | --- | --- |
| Input | `B-Spline List` | Collection Object Name Ref List |
| Input | `Number of Evenly Spaced Points` | Integer |
| Input | `Resultant Group Name` | Collection Object Name |
| Input | `Resultant Point Name Prefix` | String |
...
| Input | `Maximum Chord Length` | Double |
| Input | `Resultant Group Name` | Collection Object Name |
| Input | `Resultant Point Name Prefix` | String |
...
<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Points and Groups" data-validation="at-risk-object-fixture">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
...
<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Points and Groups" data-validation="at-risk-interactive-surface-fixture">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
...
| --- | --- | --- |
| Input | `Surface List` | Collection Object Name Ref List |
| Input | `UV Point Group Base Name` | String |
| Input | `Make Each Line Separate Group?` | Boolean |
| Input | `Number of U Grids` | Integer |
| Input | `Number of V Grids` | Integer |
| Input | `Edge Point Mode` | Edge Mode |
...
| --- | --- | --- |
| Input | `Object Name` | Collection Object Name |
| Input | `Resultant Point Name` | Point Name |
...
| Direction | Exact MP Argument | Argument Kind |
| --- | --- | --- |
| Input | `Original Points` | Point Name Ref List |
| Input | `Group for New Points` | Collection Object Name |
| Input | `Shift Vector` | Vector |
...
| Direction | Exact MP Argument | Argument Kind |
| --- | --- | --- |
| Input | `Reference Object Name` | Collection Object Name |
| Input | `Original Points` | Point Name Ref List |
| Input | `Group for New Points` | Collection Object Name |
| Input | `Radial Shift` | Double |
| Input | `Theta Shift (degrees)` | Double |
| Input | `Planar Shift` | Double |
...
<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Points and Groups" data-validation="at-risk-live-state-fixture">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
...
| Direction | Exact MP Argument | Argument Kind |
| --- | --- | --- |
| Input | `Groups to Select From` | Collection Object Name Ref List |
| Input | `WildCard Selection Names` | Point Name |
| Input | `Group for New Points` | Collection Object Name |
| Input | `Include prior complete name` | Boolean |
...
| Direction | Exact MP Argument | Argument Kind |
| --- | --- | --- |
| Input | `Points to Subsample` | Point Name Ref List |
| Input | `Subset Size` | Integer |
| Input | `Group for Subset` | Collection Object Name |
...
<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Points and Groups" data-validation="at-risk-exact-pointgrid-binding">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
...
| Input | `X Min` | Double |
| Input | `X Max` | Double |
| Input | `X Count` | Integer |
| Input | `Y Min` | Double |
| Input | `Y Max` | Double |
| Input | `Y Count` | Integer |
| Input | `Z Min` | Double |
| Input | `Z Max` | Double |
| Input | `Z Count` | Integer |
...
<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Points and Groups" data-validation="at-risk-correspondence-fixture">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
...
| Direction | Exact MP Argument | Argument Kind |
| --- | --- | --- |
| Input | `Reference group (known point names)` | Collection Object Name |
| Input | `Group to be copied (unknown point names)` | Collection Object Name |
| Input | `Auto-correspond same-point tolerance` | Double |
| Input | `Group to contain matched points` | Collection Object Name |
...
<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Points and Groups" data-validation="at-risk-group-fixture">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
...
| Input | `Resulting Group Name` | Collection Object Name |
| Input | `RMS Tolerance (0.0 for none)` | Double |
| Input | `Maximum Absolute Tolerance (0.0 for none)` | Double |
| Input | `Maximum Average Tolerance (0.0 for none)` | Double |
...
<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Points and Groups" data-validation="at-risk-instrument-obscuration-fixture">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
...
<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="excluded" data-group="Construction Operations / Points and Groups" data-validation="portable-value-construction">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--excluded">Excluded</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
  <span className="catalog-target-validation">Portable value construction</span>
</div>
<div className="catalog-target-context" data-target="2024.1.0508.5" data-status="excluded" data-group="Construction Operations / Points and Groups" data-validation="evidence-review">
...
<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Points and Groups" data-validation="at-risk-interactive-validation">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
...
<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Points and Groups" data-validation="at-risk-mutated-output-validation">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
...
<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="excluded" data-group="Construction Operations / Points and Groups" data-validation="portable-list-construction">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--excluded">Excluded</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
  <span className="catalog-target-validation">Portable list construction</span>
</div>
<div className="catalog-target-context" data-target="2024.1.0508.5" data-status="excluded" data-group="Construction Operations / Points and Groups" data-validation="evidence-review">
  <strong>SA 2024.1.0508.5</strong> <span className="catalog-status catalog-status--excluded">Excluded</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
...
| Input | `Group Name Wildcard Criteria` | String |
| Input | `Point Name Wildcard Criteria` | String |
| Output | `Resultant Point Name List` | Point Name Ref List |
...
<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="excluded" data-group="Construction Operations / Points and Groups" data-validation="portable-list-operation">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--excluded">Excluded</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
  <span className="catalog-target-validation">Portable list operation</span>
</div>
<div className="catalog-target-context" data-target="2024.1.0508.5" data-status="excluded" data-group="Construction Operations / Points and Groups" data-validation="evidence-review">
  <strong>SA 2024.1.0508.5</strong> <span className="catalog-status catalog-status--excluded">Excluded</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
...
| Direction | Exact MP Argument | Argument Kind |
| --- | --- | --- |
| Input | `Point Name List A` | Point Name Ref List |
| Input | `Point Name List B` | Point Name Ref List |
| Output | `Resultant Point Name List(A+B)` | Point Name Ref List |
...
<div className="catalog-target-contexts">
<div className="catalog-target-context" data-target="2026.1.0529.7" data-status="current" data-group="Construction Operations / Points and Groups" data-validation="at-risk-hidden-point-workflow-fixture">
  <strong>SA 2026.1.0529.7</strong> <span className="catalog-status catalog-status--current">Current</span>
  <span className="catalog-target-group">Construction Operations / Points and Groups</span>
...
| Direction | Exact MP Argument | Argument Kind |
| --- | --- | --- |
| Input | `Hidden Point Rod Name` | String |
| Input | `A to B (Target to Target) Distance` | Double |
| Input | `A to C (Target to Tip) Distance` | Double |
| Input | `A to B Inter-point Tolerance (0.0 for none)` | Double |
| Output | `Hidden Point Rod Index` | Integer |
...
| Direction | Exact MP Argument | Argument Kind |
| --- | --- | --- |
| Input | `Hidden Point Rod Index` | Integer |
...
| Direction | Exact MP Argument | Argument Kind |
| --- | --- | --- |
| Input | `End A Point Name` | Point Name |
| Input | `End B Point Name` | Point Name |
| Input | `Hidden Point Rod Index` | Integer |
| Input | `Overwrite existing point?` | Boolean |
| Input | `Point Name To Create` | Point Name |
