...
<CatalogFilter scopedGroup="Construction Operations / Other MP Types" />

<table className="catalog-command-table">
<thead><tr><th>MP Command</th><th>Status</th><th>Validation</th></tr></thead>
<tbody>
<tr data-command="Make a Boolean" data-group="Construction Operations / Other MP Types" data-status="excluded" data-validation="portable-contract-review"><td><a href="#make-a-boolean">Make a Boolean</a></td><td><span className="catalog-status catalog-status--excluded">Excluded</span></td><td>Portable contract review</td></tr>
<tr data-command="Make a Integer" data-group="Construction Operations / Other MP Types" data-status="excluded" data-validation="portable-contract-review"><td><a href="#make-a-integer">Make a Integer</a></td><td><span className="catalog-status catalog-status--excluded">Excluded</span></td><td>Portable contract review</td></tr>
<tr data-command="Make a Integer from String" data-group="Construction Operations / Other MP Types" data-status="excluded" data-validation="portable-contract-review"><td><a href="#make-a-integer-from-string">Make a Integer from String</a></td><td><span className="catalog-status catalog-status--excluded">Excluded</span></td><td>Portable contract review</td></tr>
<tr data-command="Make a Double" data-group="Construction Operations / Other MP Types" data-status="excluded" data-validation="portable-contract-review"><td><a href="#make-a-double">Make a Double</a></td><td><span className="catalog-status catalog-status--excluded">Excluded</span></td><td>Portable contract review</td></tr>
...
<tr data-command="Make a Double from String" data-group="Construction Operations / Other MP Types" data-status="excluded" data-validation="portable-contract-review"><td><a href="#make-a-double-from-string">Make a Double from String</a></td><td><span className="catalog-status catalog-status--excluded">Excluded</span></td><td>Portable contract review</td></tr>
<tr data-command="Make a Double List" data-group="Construction Operations / Other MP Types" data-status="excluded" data-validation="portable-contract-review"><td><a href="#make-a-double-list">Make a Double List</a></td><td><span className="catalog-status catalog-status--excluded">Excluded</span></td><td>Portable contract review</td></tr>
...
<tr data-command="Make a String" data-group="Construction Operations / Other MP Types" data-status="excluded" data-validation="portable-contract-review"><td><a href="#make-a-string">Make a String</a></td><td><span className="catalog-status catalog-status--excluded">Excluded</span></td><td>Portable contract review</td></tr>
...
<tr data-command="Make Axis Identifier from String" data-group="Construction Operations / Other MP Types" data-status="excluded" data-validation="portable-contract-review"><td><a href="#make-axis-identifier-from-string">Make Axis Identifier from String</a></td><td><span className="catalog-status catalog-status--excluded">Excluded</span></td><td>Portable contract review</td></tr>
