---
title: MS Office Reporting Operations Commands
description: Canonical SpatialAnalyzer MP command dispositions for MS Office Reporting Operations.
toc_max_heading_level: 2
---

import CatalogFilter from '@site/src/components/CatalogFilter';

# MS Office Reporting Operations Commands
...
<div className="catalog-command-meta">
  ...
  <div><span>MP Group Path</span><strong>MS Office Reporting Operations</strong></div>
...
| --- | --- | --- | --- | --- |
| Input | `Caption for Figure` | String | Empty | Not applicable |
| Input | `Percentage of Page Width (10-100)` | Integer | 0 | Not applicable |
...
| Direction | Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `Object Name List (Objects to Report)` | Collection Object Name Ref List | See MP definition | Not applicable |
...
| Direction | Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `Text to Add` | Edit Text | See MP definition | Not applicable |
...
| Direction | Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `RTF File` | File Path or Embedded File | Empty | Not applicable |
...
| Direction | Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `Section Heading` | String | Empty | Not applicable |
| Input | `Heading Level Designator` | SDK-unavailable MP argument | Unavailable | Not applicable |

### Briosa Disposition

The exact SDK cannot supply `Heading Level Designator`, so Briosa cannot expose the complete useful operation.
...
| Direction | Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `Caption for Figure` | String | Not established | Not applicable |
| Input | `Percentage of Page Width (10-100)` | Integer | Not established | Not applicable |
| Input | `File to Add` | File Path or Embedded File | Not established | Not applicable |
...
| Direction | Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `Report File Path` | File Path or Embedded File | Empty | Not applicable |
| Input | `Title for Document` | String | Empty | Not applicable |
| Input | `Template File Path(optional)` | File Path or Embedded File | Empty | Not applicable |
...
| Input | `Caption for Figure` | String | Empty | Not applicable |
| Input | `Percentage of Page Width (10-100)` | Integer | 0 | Not applicable |
| Input | `File to Add` | File Path or Embedded File | Empty | Not applicable |
...
| Direction | Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `Table` | SDK-unavailable MP argument | Unavailable | Not applicable |

### Briosa Disposition

The exact SDK cannot supply `Table`, so Briosa cannot expose the complete useful operation.
...
| Direction | Argument | MP Type | MP Editor Default | Briosa Default |
| --- | --- | --- | --- | --- |
| Input | `Portrait?` | Boolean | false | Not applicable |
