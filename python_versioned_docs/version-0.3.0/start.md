...
[SA 2026.1.0529.7](/api/python/start) · [SA 2024.1.0508.5](/api/python/sa-2024.1.0508.5/start)
...
| --- | --- | --- |
| `server_selection` | `BriosaServerSelection()` | [Per-application server selection](./installation-selection.md). |
