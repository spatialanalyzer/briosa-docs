...
Use this SA 2024 reference; the [SA 2026 reference](/api/python) covers the other released exact target. Arguments, choices, and command availability can differ.
...
Start with the [`BriosaClient` lifecycle](/api/python/sa-2024.1.0508.5/lifecycle) to understand
...
This section covers **SA 2024.1.0508.5**. Return to [SA 2026.1.0529.7](/api/python). Both references belong to product release 0.3.0.
