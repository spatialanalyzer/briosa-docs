...
report = discover_installations(BriosaServerSelection(minimum_version="0.8.0"))
...
[Released Source](https://github.com/spatialanalyzer/briosa-py/blob/v0.3.0/targets/2026.1.0529.7/src/briosa/installation_models.py)
