...
Both targets are published as client **0.3.0**. Use Server **0.8.0**, or the
...
For SA 2024, use `dotnet add package Briosa.2024.1.0508.5 --version 0.3.0`.
...
For SA 2024, use `python -m pip install briosa-2024-1-0508-5==0.3.0`.
