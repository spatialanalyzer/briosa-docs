...
<div className="margin-bottom--md"><a className="button button--primary button--lg" href="https://briosa.dev/downloads/packages/installer/0.2.2/briosa-installer-0.2.2-win-x64-setup.exe" download>Download Briosa Installer</a></div>

**Version 0.2.2 · Windows x64 · Complete offline setup**

[SHA-256 checksum](https://briosa.dev/downloads/packages/installer/0.2.2/briosa-installer-0.2.2-win-x64-setup.exe.sha256)
· [Release notes](https://github.com/spatialanalyzer/briosa-installer/releases/tag/v0.2.2)
· [All downloads](https://briosa.dev/downloads)

Installer 0.2.2 and Server 0.6.1 include security-patched .NET runtime 10.0.12.
...
2. Open the downloaded `briosa-installer-0.2.2-win-x64-setup.exe` file.
