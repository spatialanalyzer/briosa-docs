...
const report = await discoverInstallations({ minimumVersion: "0.8.0" });
...
[Released Source](https://github.com/spatialanalyzer/briosa-js/blob/v0.3.0/targets/2024.1.0508.5/src/installationModels.ts)
