...
[SA 2026.1.0529.7](/api/dotnet/mp-subroutines) · [SA 2024.1.0508.5](/api/dotnet/sa-2024.1.0508.5/mp-subroutines)
...
[MP Catalog](/mp-command-catalog/commands/mp-subroutines#run-subroutine) · [gRPC Contract](/api/grpc/mp-subroutines#run-subroutine)
