...
but are not exposed by the 0.8.0 service. Their reference pages state that limit.

The [released protobuf source](https://github.com/spatialanalyzer/briosa/tree/v0.8.0/targets/2026.1.0529.7/proto/briosa)
