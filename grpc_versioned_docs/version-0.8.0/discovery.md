...
description: Server 0.8.0 identity, compatibility, readiness, and capability RPCs for SA 2026.1.0529.7.
---
...
Server 0.8.0 declares behavioral contract **major 1, revision 0** for its exact target. `GetServerInfoResponse.compatibility` (field 11) is independent of product version and source revision. Matching these coordinates does not bypass exact SA/SDK identity, ownership, runtime admission, or readiness checks. An unavailable runtime identity must not be inferred from the configured target.
...
[Released Discovery Source](https://github.com/spatialanalyzer/briosa/blob/v0.8.0/targets/2026.1.0529.7/proto/briosa/discovery.proto) · [Version Coordinates](https://github.com/spatialanalyzer/briosa/blob/v0.8.0/targets/2026.1.0529.7/proto/briosa/version_coordinates.proto)
