...
[MP Catalog](/mp-command-catalog/commands/cloud-and-mesh-operations#clear-cloud-point-deviations)

`/briosa.CloudAndMeshOperations/ClearCloudPointDeviations` · Operation ID: `cloud_and_mesh_operations.clear_cloud_point_deviations`
...
| Request | 9 | `include_proximity_points` | `optional bool` | Include Proximity Points? | false |
| Result | 1000 | `execution` | `MpExecutionDetails` | Execution Details | — |
...
[MP Catalog](/mp-command-catalog/commands/cloud-and-mesh-operations#filter-clouds-to-vector-groups---resolve-clouds)

`/briosa.CloudAndMeshOperations/FilterCloudsToVectorGroupsResolveClouds` · Operation ID: `cloud_and_mesh_operations.filter_clouds_to_vector_groups_resolve_clouds`

| Message | Field | Name | Type | MP Argument | Briosa Default |
| --- | ---: | --- | --- | --- | --- |
| Request | 1 | `cloud_names` | `repeated CollectionObjectName` | Cloud Names | Required |
| Request | 2 | `vector_group_names` | `repeated CollectionObjectName` | Vector Group Names | Required |
| Request | 3 | `radial_cutoff` | `optional double` | Radial Cutoff | 0.100000 |
| Request | 4 | `lower_cutoff` | `optional double` | Lower Cutoff | -0.100000 |
| Request | 5 | `upper_cutoff` | `optional double` | Upper Cutoff | 0.100000 |
| Request | 6 | `output_collection_name` | `optional string` | Output Collection Name | Required |
...
[MP Catalog](/mp-command-catalog/commands/cloud-and-mesh-operations#get-cloud-rgb-values)

`/briosa.CloudAndMeshOperations/GetCloudRGBValues` · Operation ID: `cloud_and_mesh_operations.get_cloud_rgb_values`

| Message | Field | Name | Type | MP Argument | Briosa Default |
| --- | ---: | --- | --- | --- | --- |
| Request | 1 | `source_cloud_name` | `optional CollectionObjectName` | Source Cloud Name | Required |
| Request | 2 | `rgb_color_channel` | `optional RGBColorChannel` | See Typed Binding | Required |
| Result | 1 | `low_value` | `optional int32` | See Typed Binding | — |
| Result | 2 | `high_value` | `optional int32` | See Typed Binding | — |
| Result | 3 | `average_value` | `optional int32` | See Typed Binding | — |
| Result | 4 | `standard_deviation` | `optional int32` | See Typed Binding | — |
| Result | 1000 | `execution` | `MpExecutionDetails` | Execution Details | — |
...
[MP Catalog](/mp-command-catalog/commands/cloud-and-mesh-operations#get-cloud-rgb-values-near-point)

`/briosa.CloudAndMeshOperations/GetCloudRGBValuesNearPoint` · Operation ID: `cloud_and_mesh_operations.get_cloud_rgb_values_near_point`

| Message | Field | Name | Type | MP Argument | Briosa Default |
| --- | ---: | --- | --- | --- | --- |
| Request | 1 | `source_cloud_name` | `optional CollectionObjectName` | Source Cloud Name | Required |
| Request | 2 | `single_point` | `optional PointName` | Single Point | Required |
| Request | 3 | `diameter` | `optional double` | Diameter | 10.000000 |
| Request | 4 | `rgb_color_channel` | `optional RGBColorChannel` | See Typed Binding | Required |
| Result | 1 | `low_value` | `optional int32` | See Typed Binding | — |
| Result | 2 | `high_value` | `optional int32` | See Typed Binding | — |
| Result | 3 | `average_value` | `optional int32` | See Typed Binding | — |
| Result | 4 | `standard_deviation` | `optional int32` | See Typed Binding | — |
...
[MP Catalog](/mp-command-catalog/commands/cloud-and-mesh-operations#subdivide-cloud-by-point-spacing)

`/briosa.CloudAndMeshOperations/SubdivideCloudByPointSpacing` · Operation ID: `cloud_and_mesh_operations.subdivide_cloud_by_point_spacing`

| Message | Field | Name | Type | MP Argument | Briosa Default |
| --- | ---: | --- | --- | --- | --- |
| Request | 1 | `source_cloud_name` | `optional CollectionObjectName` | Source Cloud Name | Required |
| Request | 2 | `point_spacing` | `optional double` | Point Spacing | 0.000000 |
| Request | 3 | `minimum_points_per_group` | `optional int32` | Minimum Points Per Group | 0 |
| Request | 4 | `new_cloud_name` | `optional CollectionObjectName` | New Cloud Name | Required |
| Request | 5 | `keep_all_groups` | `optional bool` | Keep All Groups? | true |
| Result | 1000 | `execution` | `MpExecutionDetails` | Execution Details | — |
...
[MP Catalog](/mp-command-catalog/commands/cloud-and-mesh-operations#consolidate-mesh)

`/briosa.CloudAndMeshOperations/ConsolidateMesh` · Operation ID: `cloud_and_mesh_operations.consolidate_mesh`
...
[MP Catalog](/mp-command-catalog/commands/cloud-and-mesh-operations#mesh-fill-holes)

`/briosa.CloudAndMeshOperations/MeshFillHoles` · Operation ID: `cloud_and_mesh_operations.mesh_fill_holes`

| Message | Field | Name | Type | MP Argument | Briosa Default |
| --- | ---: | --- | --- | --- | --- |
| Request | 1 | `mesh` | `optional CollectionObjectName` | Mesh | Required |
| Request | 2 | `maximum_triangle_length` | `optional double` | Maximum Triangle Length | -1.000000 |
| Request | 3 | `tension` | `optional double` | Tension | 0.000000 |
| Request | 4 | `unconditional_filling` | `optional bool` | Unconditional Filling? | false |
| Request | 5 | `fill_all_holes` | `optional bool` | Fill All Holes? | true |
| Result | 1000 | `execution` | `MpExecutionDetails` | Execution Details | — |
