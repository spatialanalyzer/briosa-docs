...
| Message | Field | Name | Type | MP Argument | Briosa Default |
| --- | ---: | --- | --- | --- | --- |
| Request | 1 | `construct_planes` | `optional bool` | Construct Planes? | Required |
| Request | 2 | `construct_cylinders` | `optional bool` | Construct Cylinders? | Required |
| Request | 3 | `construct_spheres` | `optional bool` | Construct Spheres? | Required |
| Request | 4 | `construct_cones` | `optional bool` | Construct Cones? | Required |
| Request | 5 | `construct_lines` | `optional bool` | Construct Lines? | Required |
| Request | 6 | `construct_points` | `optional bool` | Construct Points? | Required |
| Request | 7 | `construct_circles` | `optional bool` | Construct Circles? | Required |
| Result | 1000 | `execution` | `MpExecutionDetails` | Execution Details | — |
...
message ConstructObjectsFromSurfaceFacesRuntimeSelectRequest {
  // Explicit choices are required; captured examples do not establish omission defaults.
  optional bool construct_planes = 1;
  optional bool construct_cylinders = 2;
  optional bool construct_spheres = 3;
  optional bool construct_cones = 4;
  optional bool construct_lines = 5;
  optional bool construct_points = 6;
  optional bool construct_circles = 7;
}
