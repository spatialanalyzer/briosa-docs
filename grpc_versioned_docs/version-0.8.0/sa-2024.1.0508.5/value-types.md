...
description: Server 0.8.0 exact-target protobuf values for SA 2024.1.0508.5.
---
...
These are the released Server **0.8.0** protobuf values for **SA 2024.1.0508.5**. Preserve reserved numbers and exact-target domains. Client libraries expose their own handwritten representations.
...
message FeatureCheckReportingOptions {
  ...
  reserved 5;
  reserved "only_create_failed_vectors";
...
enum ItemType {
  reserved 10;
  reserved "ITEM_TYPE_ENHANCED_CLOUD";
...
enum ObjectType {
  reserved 5;
  reserved "OBJECT_TYPE_ENHANCED_CLOUD";
...
enum SystemString {
  reserved 12 to 14;
  reserved "SYSTEM_STRING_LICENSE_USER_NAME", "SYSTEM_STRING_WINDOWS_USER_NAME", "SYSTEM_STRING_COMPUTER_NAME";
...
[Released Source](https://github.com/spatialanalyzer/briosa/tree/v0.8.0/targets/2024.1.0508.5/proto/briosa)
