...
description: Server 0.8.0 exact-target protobuf values for SA 2026.1.0529.7.
---
...
These are the released Server **0.8.0** protobuf values for **SA 2026.1.0529.7**. Preserve reserved numbers and exact-target domains. Client libraries expose their own handwritten representations.
...
[Released Source](https://github.com/spatialanalyzer/briosa/tree/v0.8.0/targets/2026.1.0529.7/proto/briosa)
