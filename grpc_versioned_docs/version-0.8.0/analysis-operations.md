...
| Result | 7 | `cut_length_from_apex` | `optional double` | Cut Length from Apex | — |
| Result | 1000 | `execution` | `MpExecutionDetails` | Execution Details | — |
...
| Request | 8 | `align_with_nominal` | `optional bool` | Align with Nominal? | false |
| Request | 9 | `reverse_axis` | `optional bool` | Reverse Axis? | false |
| Request | 10 | `set_axis_first_to_last_point` | `optional bool` | Set Axis First to Last Point? | false |
...
| Request | 4 | `refresh_filtered_cloud_data` | `optional bool` | Refresh Filtered Cloud Data? | false |
| Result | 1000 | `execution` | `MpExecutionDetails` | Execution Details | — |
...
[MP Catalog](/mp-command-catalog/commands/analysis-operations#set-cone-properties)

`/briosa.AnalysisOperations/SetConeProperties` · Operation ID: `analysis_operations.set_cone_properties`
...
| Request | 8 | `cut_length_from_apex` | `optional double` | Cut Length from Apex | 0.000000 |
| Result | 1000 | `execution` | `MpExecutionDetails` | Execution Details | — |
...
[MP Catalog](/mp-command-catalog/commands/analysis-operations#set-ellipse-properties)

`/briosa.AnalysisOperations/SetEllipseProperties` · Operation ID: `analysis_operations.set_ellipse_properties`
...
[MP Catalog](/mp-command-catalog/commands/analysis-operations#set-line-properties)

`/briosa.AnalysisOperations/SetLineProperties` · Operation ID: `analysis_operations.set_line_properties`
