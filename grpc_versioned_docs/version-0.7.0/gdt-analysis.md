...
[MP Catalog](/mp-command-catalog/commands/gdt-analysis#set-gdt-extended-options)

`/briosa.GdtOperations/SetGdtExtendedOptions` · Operation ID: `gdt_operations.set_gdt_extended_options`

| Message | Field | Name | Type | MP Argument | Briosa Default |
| --- | ---: | --- | --- | --- | --- |
| Request | 1 | `use_extended_options` | `optional bool` | Use Extended Options | true |
| Request | 2 | `circle_extended_options` | `optional GdtExtendedEvaluationMethod` | Circle Extended Options | Least Squares |
| Request | 3 | `cone_extended_options` | `optional GdtExtendedEvaluationMethod` | Cone Extended Options | Least Squares |
| Request | 4 | `cylinder_extended_options` | `optional GdtExtendedEvaluationMethod` | Cylinder Extended Options | Least Squares |
| Request | 5 | `ellipse_extended_options` | `optional GdtExtendedEvaluationMethod` | Ellipse Extended Options | Least Squares |
| Request | 6 | `line_extended_options` | `optional GdtExtendedEvaluationMethod` | Line Extended Options | Least Squares |
| Request | 7 | `open_slot_extended_options` | `optional GdtExtendedEvaluationMethod` | Open Slot Extended Options | Least Squares |
| Request | 8 | `plane_extended_options` | `optional GdtExtendedEvaluationMethod` | Plane Extended Options | Least Squares |
| Request | 9 | `slot_extended_options` | `optional GdtExtendedEvaluationMethod` | Slot Extended Options | Least Squares |
| Request | 10 | `sphere_extended_options` | `optional GdtExtendedEvaluationMethod` | Sphere Extended Options | Least Squares |
| Result | 1000 | `execution` | `MpExecutionDetails` | Execution Details | — |

```proto
rpc SetGdtExtendedOptions(SetGdtExtendedOptionsRequest) returns (SetGdtExtendedOptionsResult);
...
message SetGdtExtendedOptionsResult {
  MpExecutionDetails execution = 1000;
}
```
...
[MP Catalog](/mp-command-catalog/commands/gdt-analysis#get-gdt-extended-options)

`/briosa.GdtOperations/GetGdtExtendedOptions` · Operation ID: `gdt_operations.get_gdt_extended_options`

| Message | Field | Name | Type | MP Argument | Briosa Default |
| --- | ---: | --- | --- | --- | --- |
| Result | 1 | `use_extended_options` | `bool` | Use Extended Options | — |
| Result | 1000 | `execution` | `MpExecutionDetails` | Execution Details | — |

```proto
rpc GetGdtExtendedOptions(GetGdtExtendedOptionsRequest) returns (GetGdtExtendedOptionsResult);
...
| Request | 6 | `only_create_failed_vectors` | `optional bool` | Only Create Failed Vectors? | false |
