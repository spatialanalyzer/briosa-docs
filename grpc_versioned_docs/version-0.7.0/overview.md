...
This reference documents **Briosa Server 0.7.0** for exact SpatialAnalyzer
target **2026.1.0529.7**. It covers lifecycle services, MP operations,
...
source APIs. The three client families are published as version 0.2.0 for both exact targets.
...
`RunCribSheet`, `ProjectObjects`, and `StopProjection` are documented proposals
but are not exposed by the 0.7.0 service. Their reference pages state that limit.

The [released protobuf source](https://github.com/spatialanalyzer/briosa/tree/v0.7.0/targets/2026.1.0529.7/proto/briosa)
...
This section covers **SA 2026.1.0529.7**. Select [SA 2024.1.0508.5](/api/grpc/sa-2024.1.0508.5) for its released signatures and types.
