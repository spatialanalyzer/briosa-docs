...
| --- | ---: | --- | --- | --- | --- |
| Request | 1 | `instrument` | `optional CollectionInstrumentId` | Instrument ID | Required |
| Result | 1 | `reference_arm_length_inches` | `double` | Ref Arm Length (Inches) | — |
| Result | 2 | `reference_arm_quality` | `double` | Ref Arm Quality | — |
| Result | 3 | `mirror_measurement_count` | `int32` | Mirror Measurement Count | — |
| Result | 4 | `mirror_measurement_range_mean_inches` | `double` | Mirror Measurement Range - Mean (Inches) | — |
| Result | 5 | `mirror_measurement_range_standard_deviation_inches` | `double` | Mirror Measurement Range - StdDev (Inches) | — |
...
| --- | ---: | --- | --- | --- | --- |
| Request | 1 | `instrument` | `optional CollectionInstrumentId` | Instrument ID | Required |
| Result | 1 | `linearity_khz` | `double` | Linearity (kHz) | — |
| Result | 1000 | `execution` | `MpExecutionDetails` | Execution Details | — |
