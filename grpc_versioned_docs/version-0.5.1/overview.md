...
This reference documents **Briosa Server 0.5.1** for exact SpatialAnalyzer
...
but are not exposed by the 0.5.1 service. Their reference pages state that limit.

The [released protobuf source](https://github.com/spatialanalyzer/briosa/tree/v0.5.1/targets/2026.1.0529.7/proto/briosa)
