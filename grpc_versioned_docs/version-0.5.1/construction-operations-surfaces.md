...
description: Released gRPC contracts for surface construction MP commands.
...
while omission succeeded and returned a Cylinder. This released contract therefore
